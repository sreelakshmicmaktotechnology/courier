              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(220.0, 0.0, 0.0, 0.0),
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => Text(
                          valueOrDefault(currentUserDocument?.address1, ''),
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Readex Pro',
                                    letterSpacing: 1.5,
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => Text(
                        valueOrDefault(currentUserDocument?.address2, ''),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                              letterSpacing: 1.5,
                            ),
