    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: StreamBuilder<NumberRecord>(
          stream: NumberRecord.getDocument(widget.userDef!),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          await widget.userDef!.update(createNumberRecordData(
                            wallet: int.tryParse(_model.textController2.text),
                          ));
                          context.safePop();
                        },
                        text: 'Load Wallet',
