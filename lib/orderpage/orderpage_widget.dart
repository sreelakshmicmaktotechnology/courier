                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 30.0, 0.0),
                        child: TextFormField(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          measurement: double.tryParse(
                              _model.measureTextController.text),
                          shipementvalue:
                              int.tryParse(_model.moneyTextController.text),
                        ...
                        await OrderRecord.collection
                            ...
                            .set(createOrderRecordData(
                              ...
                              measurement: _model.measureTextController.text,
                              shipmentvalue: _model.moneyTextController.text,
                              content: _model.dropDownValue,
                              orderid: random_data
                                  .randomInteger(10000, 10000000)
                                  .toString(),
