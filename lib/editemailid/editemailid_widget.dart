  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: StreamBuilder<NumberRecord>(
            stream: NumberRecord.getDocument(widget.userRef!),
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              30.0, 0.0, 0.0, 0.0),
                          child: Text(
                            'We will send an OTP to verify your email ID',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Readex Pro',
                                  color: const Color(0xAF7E7777),
                                  letterSpacing: 0.0,
                                ),
                          ),
                        ),
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: columnNumberRecord.email,
