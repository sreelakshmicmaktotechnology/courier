...
import 'newaddress_model.dart';
export 'newaddress_model.dart';
                          ...
                          child: SizedBox(
                            ...
                            child: Autocomplete<String>(
                              ...
                              optionsBuilder: (textEditingValue) {
                                ...
                                return functions.getcountry().where((option) {
                              ...
                              onSelected: (String selection) {
                                setState(() => _model.textFieldSelectedOption4 =
                                    selection);
                                FocusScope.of(context).unfocus();
                              },
                              fieldViewBuilder: (
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await currentUserReference!
                                .update(createNumberRecordData(
                              address1: _model.textController1.text,
                              address2: _model.textController2.text,
